...
def test_knockout_winner_draw_resolved_by_lambda_with_penalties():
    ...
    # Usar um palpite explicitamente empatado (simulado)
    from copa2026.ratings import ScorePrediction
    # Criar um prediction com palpite empatado para testar a lógica de desempate
    pred = ScorePrediction(
        home="A",
        away="B",
        palpite=(1, 1),  # empate garantido
        lambda_home=1.2,
        lambda_away=1.2,
